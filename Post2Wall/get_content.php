...
if (!empty($description)) {
    echo ' <label class="desc"> ' . substr($description, 0, 200) . ' </label>';
...
if (count($images_url) > 1) {
    ...
    echo '  <label style="float:left"><img src="image/prev.png" id="prev" alt=""/><img src="image/next.png" id="next" alt=""/></label>';
